...
export function isShell(id) {
    return registry.get(id)?.is_shell === true;
}
export function inputMode(id) {
...
export function renderLogo(coder) {
...
export function formatAttachment(coderId, path) {
...
export function isRecipeRunning(paneId) {
