...
func main() {
	...
	http.HandleFunc("/api/config/use-hidden-terminal", handleUseHiddenTerminal)
	http.HandleFunc("/api/cmd/run", handleRunCommand)
	http.HandleFunc("/api/cmd/batch-run", handleRunCommand)
