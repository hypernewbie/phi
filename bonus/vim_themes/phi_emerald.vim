...
hi CursorLineNr     guifg=#6ee7b7 gui=bold
...
hi Search           guifg=#14141a guibg=#6ee7b7
hi IncSearch        guifg=#14141a guibg=#10b981
hi Pmenu            guifg=#e4e3e9  guibg=#0d0d10
hi PmenuSel         guifg=#6ee7b7 guibg=#1f1f26  gui=bold
hi PmenuSbar                     guibg=#141418
hi PmenuThumb                    guibg=#78768a
hi MatchParen       guifg=#6ee7b7 guibg=#1f1f26  gui=bold
hi Directory        guifg=#10b981

" Syntax Highlighting
hi Comment          guifg=#505060 gui=italic
hi Constant         guifg=#6ee7b7
hi String           guifg=#a7f3d0
hi Character        guifg=#a7f3d0
hi Number           guifg=#6ee7b7
hi Boolean          guifg=#6ee7b7
hi Float            guifg=#6ee7b7

hi Identifier       guifg=#e4e3e9
hi Function         guifg=#10b981

hi Statement        guifg=#6ee7b7 gui=bold
hi Conditional      guifg=#6ee7b7 gui=bold
hi Repeat           guifg=#6ee7b7 gui=bold
hi Label            guifg=#6ee7b7
hi Operator         guifg=#10b981
hi Keyword          guifg=#6ee7b7 gui=bold
...
hi DiffText         guifg=#6ee7b7  guibg=#1f1f26  gui=bold
