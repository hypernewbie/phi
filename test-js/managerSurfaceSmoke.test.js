...
const expectations = [
    ...
    {
        cls: 'SessionsManager',
        newFn: () => new SessionsManager(app),
        method: ['loadConfig', 'loadSessions', 'loadWorktrees'],
        field: ['activeCWD', 'activeWorkspace', 'config'],
    },
    {
        cls: 'DiffController',
        newFn: () => new DiffController(app),
        method: ['refreshDiff'],
        field: ['isPanelOpen', 'activeTab'],
    },
    {
        cls: 'MarkdownManager',
        newFn: () => new MarkdownManager(app),
        method: ['refreshFiles'],
        field: [],
    },
    {
        cls: 'FileTreeManager',
        newFn: () => new FileTreeManager(app),
        method: ['refresh'],
        field: [],
    },
    {
        cls: 'SyncManager',
        newFn: () => new SyncManager(app),
        method: ['refreshMessages'],
        field: [],
    },
    {
        cls: 'KanbanManager',
        newFn: () => new KanbanManager(app),
        method: [],
        field: [],
    },
];
